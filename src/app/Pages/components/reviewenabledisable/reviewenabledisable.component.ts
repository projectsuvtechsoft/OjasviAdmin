...
@Component({
  selector: 'app-reviewenabledisable',
  templateUrl: './reviewenabledisable.component.html',
  styleUrls: ['./reviewenabledisable.component.css']
})
export class ReviewenabledisableComponent {
 drawerVisible!: boolean;
  drawerTitle!: string;
  drawerData: reviewenabledisable = new reviewenabledisable();
  formTitle = 'Manage Reviews';
  @Input()
  dataList: any[] = [];
  // dataList = [];
  loadingRecords = true;
  ...
  add(): void {
    this.drawerTitle = ' Add New Charges ';
    this.drawerData = new reviewenabledisable();
  ...
  edit(data: reviewenabledisable): void {
    this.drawerTitle = 'Enable/Disable Review';
  ...
  onChangeStatus(data,status){
      if (data.ID) {
        ...
        this.api.updateReviewstatus(data).subscribe((successCode) => {
