...
import { reviewenabledisable } from 'src/app/Models/revieweabledisablemodel';
import { ApiServiceService } from 'src/app/Service/api-service.service';

@Component({
  selector: 'app-reveiwenabledisabledrawer',
  templateUrl: './reveiwenabledisabledrawer.component.html',
  styleUrls: ['./reveiwenabledisabledrawer.component.css']
})
export class ReveiwenabledisabledrawerComponent {
@Input()
  ...
  @Input()
  data: reviewenabledisable = new reviewenabledisable();
  @Input()
  ...
  resetDrawer(websitebannerPage: NgForm) {
    this.data = new reviewenabledisable();
  ...
  gettabledata() {
    this.api.getAllCharges(0, 0, '', '', '').subscribe(
      (data) => {
        if (data['code'] == 200) {
  ...
  //   }
    ...
    if (this.isOk) {
      ...
      if (this.data.ID) {
        this.api.updateReviewstatus(this.data).subscribe((successCode) => {
      ...
      //           // this.api.getAllreviewenabledisable(1, 1, '', 'desc', '').subscribe(
      //           //   (data) => {
      //           //     if (data['count'] == 0) {
