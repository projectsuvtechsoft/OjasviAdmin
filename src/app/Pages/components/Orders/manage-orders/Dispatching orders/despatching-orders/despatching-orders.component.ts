...
@Component({
  selector: 'app-despatching-orders',
  templateUrl: './despatching-orders.component.html',
  styleUrls: ['./despatching-orders.component.css'],
})
export class DespatchingOrdersComponent implements OnInit {
  drawerVisible: boolean = false;
  drawerTitle!: string;
  drawerData: OrderDetailMaster = new OrderDetailMaster();
  formTitle = 'Pending Dispatch/ Store Transfer Pending';
  dataList = [];
  ...
  columns: string[][] = [
    ...
    ['ACTUAL_PREPARE_DISPATCH_DATETIME', 'ACTUAL_PREPARE_PACKAGING_DATETIME'],
...
back() {
  ...
  edit(data: OrderDetailMaster): void {
    ...
    this.drawerTitle = 'Dispatching List Details';
