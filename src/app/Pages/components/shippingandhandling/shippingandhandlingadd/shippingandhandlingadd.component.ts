...
@Component({
  selector: 'app-shippingandhandlingadd',
  templateUrl: './shippingandhandlingadd.component.html',
  styleUrls: ['./shippingandhandlingadd.component.css']
})
export class ShippingandhandlingaddComponent {
@Input()
  ...
  @Input()
  data: shippingandhandling = new shippingandhandling();
  @Input()
  ...
  resetDrawer(websitebannerPage: NgForm) {
    this.data = new shippingandhandling();
  ...
  if (this.data.KEY1 == undefined || this.data.KEY1.trim()=="") {
    ...
    if (this.isOk) {
      ...
      if (this.data.ID) {
        this.api.updateCharges(this.data).subscribe((successCode) => {
          ...
          .subscribe((successCode) => {
            if (successCode.code == '200') {
              ...
              if (!addNew) this.drawerClose();
                ...
                // this.api.getAllshippingandhandling(1, 1, '', 'desc', '').subscribe(
                //   (data) => {
                //     if (data['count'] == 0) {
